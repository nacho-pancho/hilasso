function [predict_labels evd_time kmeans_time total_time] = nystrom(data, num_samples, sigma, num_clusters)
...
% Restore predict_labels in original order
predict_labels(permed_index) = predict_labels;
clear permed_index;
total_time = toc;
