...
%         aSetD(i,j) = mean(sum(A~=0));
        ...
        for h = 1:length(lambda1)
            ...
            for f=1:length(lambda2)
                ...
                mseC(h,f,i,j) = norm(full(Ao-AC),'fro')/N;
...
save exp/psprech/source/gridHilasso256 errorL aSet* error* mse* V